...
<body>
  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <div class="profile">
        <img src="resources/img/profile-img.jpg" alt="" class="img-fluid rounded-circle">
        <h1 class="text-light"><a href="index.html">강주미</a></h1>
      ...
      <nav class="nav-menu">
        <ul>
          <li class="active"><a href="home.html"><i class="bx bx-home"></i> <span>Home</span></a></li>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="hero-container" data-aos="fade-in">
      <h1>포트폴리오</h1>
      <p>강주미 <span class="typed" data-typed-items="Designer, Developer, Freelancer, Photographer"></span></p>
    </div>
  </section><!-- End Hero -->
        ...
        <div class="row">
          ...
          <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="icofont-rounded-right"></i> <strong>Birthday:</strong> 29 November 1984</li>
                  <li><i class="icofont-rounded-right"></i> <strong>Website:</strong> jmkang1984.tistory.com </li>
                  <li><i class="icofont-rounded-right"></i> <strong>Phone:</strong> 010 2742 2558</li>
                  <li><i class="icofont-rounded-right"></i> <strong>City:</strong> City : Busan, Korea</li>
                </ul>
              </div>
              <div class="col-lg-6">
                <ul>
                  <li><i class="icofont-rounded-right"></i> <strong>Age:</strong> 37</li>
                  
                  <li><i class="icofont-rounded-right"></i> <strong>PhEmailone:</strong> jmkang1984@gmail.com</li>
